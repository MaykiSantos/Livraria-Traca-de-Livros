...
$router->group(['prefix' => 'api-traca'], function() use ($router){
    ...
    $router->patch('fornecedores/{cnpj}', 'FornecedoresController@update');
    $router->delete('fornecedores/{cnpj}', 'FornecedoresController@destroy');

    $router->get('funcionarios_administrativo', 'FuncionariosAdministrativo@index');
